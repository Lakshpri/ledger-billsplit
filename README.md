...
<p align="center"><i>🎥 A full demo GIF (creating a group → adding an expense → settling up) goes here — record one with <a href="https://www.screentogif.com/">ScreenToGif</a> or your OS screen recorder and drop it in <code>assets/demo.gif</code>.</i></p>
